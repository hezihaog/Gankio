...
import com.zh.home.persenter.impl.GankCategoryPresenter;
...
public class GankCategoryFragment extends BaseFragment implements IGankCategoryView {
    ...
    private void bindView() {
        ...
        mCategoryTypeAdapter.addOnItemClickListener(new OnItemClickListener<GankBean.ResultsBean>() {
            ...
            public void onItemClick(View view, int position, GankBean.ResultsBean resultsBean) {
                mCollectService.routerArticleDetail((SupportActivity) getActivity(), mDataList.get(position));
            }
        });
    ...
    public String getPageTitle() {
        ...
        if (mCategoryType.equals(GankCategoryType.ANDROID)) {
            return BaseApplication.shareInstance().getResources().getString(R.string.page_home_android_title);
        } else if (mCategoryType.equals(GankCategoryType.IOS)) {
            return BaseApplication.shareInstance().getResources().getString(R.string.page_home_ios_title);
        } else if (mCategoryType.equals(GankCategoryType.WEB)) {
            return BaseApplication.shareInstance().getResources().getString(R.string.page_home_web_title);
        } else {
            return "";
        }
    }
