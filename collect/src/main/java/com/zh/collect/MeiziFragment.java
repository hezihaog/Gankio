...
import com.zh.base.widget.RatioImageView;
...
public class MeiziFragment extends BaseFragment implements IGankCollectionView.IObtainCollectionView {
    ...
    public void onLayoutAfter() {
        ...
        mCollectionAdapter.addOnItemClickListener(new OnItemClickListener<GankCollectionVO>() {
            ...
            public void onItemClick(View view, int position, GankCollectionVO gankCollectionVO) {
                ...
                mWelfareService.routerMeiziDetail((SupportActivity) getActivity(), meiziBeans, position);
            }
        });
    ...
    private void findView(View view) {
        mMeziRecyclerView = view.findViewById(R.id.mezi_recycler_view);
        mRefreshLayout = view.findViewById(R.id.refresh_layout);
    }

    @Override
    public String getPageTitle() {
        return BaseApplication.shareInstance().getResources().getString(R.string.page_collection_meizi_title);
    }
