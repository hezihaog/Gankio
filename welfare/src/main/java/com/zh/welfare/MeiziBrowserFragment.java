...
import com.zh.base.util.FileUtil;
import com.zh.base.util.ImageDownloadUtil;
 ...
 */
@Route(path = ARouterUrl.MEIZI_DETAIL)
public class MeiziBrowserFragment extends BaseFragment {
    ...
    private void findView(View view) {
        ...
        mDownloadImageIv = view.findViewById(R.id.download_image_iv);
    }
    ...
    public String getPageTitle() {
        return BaseApplication.shareInstance().getResources().getString(R.string.page_image_browser_title);
    }
