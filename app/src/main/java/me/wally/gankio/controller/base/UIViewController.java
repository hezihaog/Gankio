...
public abstract class UIViewController {
    ...
    private UIViewControllerManager.ViewControllerHostCallback hostCallback = new UIViewControllerManager.ViewControllerHostCallback() {
        @Override
        ...
        public Context getContext() {
            return UIViewController.this.getContext();
        }
    ...
    public UIViewControllerManager getViewControllerManager() {
        if (viewControllerManager == null) {
            viewControllerManager = new UIViewControllerManager();
    ...
    void performCreate(Bundle savedInstanceState) {
        ...
        if (!called) {
            throw new AndroidRuntimeException("ViewController " + this
                    + " did not call through to super.dispatchCreate()");
        }
    }
    ...
    View performCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        state = UIViewController.CREATED;
